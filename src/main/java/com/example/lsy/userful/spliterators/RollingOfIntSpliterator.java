...
public class RollingOfIntSpliterator implements Spliterator<IntStream> {
	...
	public static RollingOfIntSpliterator of(OfInt spliterator, int grouping) {
	...
	private RollingOfIntSpliterator(OfInt spliterator, int grouping) {
	...
	public Spliterator<IntStream> trySplit() {
		OfInt splitSpliterator = spliterator.trySplit();
